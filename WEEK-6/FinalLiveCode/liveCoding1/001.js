...
-GET villainCount = 0
-GET input (array)
-FOR each element in input I BUMP
  IF input I equals to 'Villain'
    villainCount += 1
  ELSE IF input I equals to '@'
    life -= 1
-IF life > 0
  PRINT 'Nice work, detective! You got all villains: villainCount'
 ELSE IF  life = 0
  PRINT 'Oops, you die. You got villainCount villains'
*/
